	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				...
				<input type="text" name="hargapanas" class="input-control" placeholder="Harga Panas" required>
				<input type="text" name="hargadingin" class="input-control" placeholder="Harga Dingin" required>
				<input type="file" name="gambar" class="input-control" required> <a style="color: red;">*max ukuran gambar 2mb dan file yang di izinkan jpg , jpeg , png , gif </a>
				...
				<?php 
					if(isset($_POST['submit'])){
						...
						// menampung data file yang doupload
